 ...
 * @return {boolean}
 */
// I have to make sure he has 4 in his step so I can win;
var canWinNim = function(n) {
  // I go first;
  // if there is 4, I lose;
  // so when it has 5-7, I can take 1-3 to make next is 4;
  // if there is 8, He can get into last step, then I lose;
  // when there are 9-11, I win;
  // So here is a loop, whenever I encounter 4n (n>=1); I will lose;
