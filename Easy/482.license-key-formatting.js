...
// simply remove all the hash and then reverse as an array;
// using string to store new key rather than array (as it is expensive)
var licenseKeyFormatting = function(S, K) {
  S = S.replace(/-/g,"").split("").reverse();
  let result = "";
  for(i=0; i<S.length; i++){
    if(i !==0 && i % K === 0)     result = "-" + result;
